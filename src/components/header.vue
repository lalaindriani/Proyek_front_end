  ...
  <div class="w-full bg-gray-100 ">
    <div class="flex justify-between items-center h-[50px]">
      ...
      <div class="flex space-x-3 items-center justify-center px-3">
        <div class="text-xl leading-tight mb-2">Admin</div>
        <Avatar icon="pi pi-user" class="mr-2" style="background-color:#3f51b5; color: #ffffff" shape="circle" @click="toggle" aria-haspopup="true" aria-controls="overlay_menu" />
